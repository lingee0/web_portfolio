...
const SkillsTab = () => {
  ...
  return (
    <div className="flex-row justify-between items-center w-[70%] group relative overflow-hidden bg-blue-900/20 border-2 border-white/50 rounded-xl ss:mt-5 collapsible">
      <div
        className="text-gradient text-center font-source_code_pro font-bold ss:text-[24px] text-[14px]"
        {...getToggleProps()}
      >
      ...
      <div {...getCollapseProps()}>
        <div
          className={`text-gradient justify-between font-source_code_pro flex-1 flex md:flex-row flex-col ${styles.flexCenter} ml-4 mr-4 relative`}
        >
