      ...
      >
        <div className="flex-1 lg:bg-gray-gradient mt-10">
          ...
          <p className="font-poppins text-white flexCenter max-w-[600px] mb-16">
            ...
            innovative and creative in my work, and I'm pretty good at coming up
            with "out of the box" solutions to problems. I'm also a bit of a
            perfectionist, which comes in handy when you need someone who's
            detail-oriented to get the job done right. Plus, I work great with
            others and have been known to crack a few jokes to keep the team
            morale up.
          </p>
        </div>
      </div>
